...
// $obj->insertMedewerkerUser('youssef', 'yurr123');
// $obj = new database();
...
if(isset($_POST['submit'])){
    ...
    if(!$error){
        ...
        $obj->loginexample($_POST['username'], $_POST['password']);
        //yurr
    }else{
        //do something
    }
    ...
    <div class="Vertical_Layout">
        ...
        <div class="inloggen">
            <form method="post" action="loginEmployee.php">
                ...
                <input type="password" title="password" placeholder="Password" required/><br>
                <?php echo $msg != '' ? $msg : '';?>
